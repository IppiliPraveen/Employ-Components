...
<script type="text/javascript">
	...
	function clickSave() {
		document.getElementById("MVCSAVE0002").click();
...
<body>
	...
	<div align="center">
		<f:form action="updateEmploy" method="post" modelAttribute="employ">
			<table class="tbl">
				<tr class="tr">
					<td class="td">Employ No</td>
					<td class="td"><f:input path="empId" value="${employ.empId}" readonly="true"/></td>
				</tr>
				<tr>
					<td>Name:</td>
				...
				<tr>
					...
					<button class="button" id="MVCSAVE0002" type="submit" name="Save">Save</button></td>
